...
class RemoteUrls {
  static const String rootUrl = "https://bm-flash.com:8001/";
  ...
  static String sellerDetailsUrl(String slug, int page, int perPage) => '${baseUrl}sellers/$slug?page=$page&per_page=$perPage';

  static String sellerProductsUrl(String slug, int page, int perPage) => '${baseUrl}product?shop_name=$slug&page=$page&per_page=$perPage';
  ...
  static String filterUrl(int page, int perPage) => '${baseUrl}search-product?page=$page&per_page=$perPage';
  ...
  static const String brandLists = '${baseUrl}brand-list';
  ...
  static String highlightProductsUrl(String keyword, int page, int perPage) =>
  ...
  static String categoryProducts(String slug, int page, int perPage) =>
      '${baseUrl}product?category=$slug&page=$page&per_page=$perPage';

  static String brandProducts(String slug, int page, int perPage) => '${baseUrl}product?brand=$slug&page=$page&per_page=$perPage';
