...
class Language {
  ...
  static String onBoardingTitle1 = myMap['on_boarding_title_1'];
  static String onBoardingTitle2 = myMap['on_boarding_title_2'];
  static String onBoardingTitle3 = myMap['on_boarding_title_3'];
  static String onBoardingSubTitle = myMap['on_boarding_subtitle'];
  static String onBoardingSubTitle1 = myMap['on_boarding_subtitle_1'];
  static String onBoardingSubTitle2 = myMap['on_boarding_subtitle_2'];
  static String onBoardingSubTitle3 = myMap['on_boarding_subtitle_3'];
  ...
  static String yourAddresses = myMap['Your_addresses'];
  ...
  static String addresses = myMap['Addresses'];
  ...
  static String ourBrands = myMap['Our_Brands'];
  ...
  static String signInHere = myMap['Sign_In_Here'];
  static String signInPlease = myMap['Sign_in_please'];
  static String signIn = myMap['Sign_in'];

  static String storagePermissionsAreDenied =
      myMap['Storage_permissions_denied'];
  static String locationServicesAreDisabled =
      myMap['Location_services_are_disabled'];
  static String locationPermissionsAreDenied =
      myMap['Location_permissions_are_denied'];
  static String locationPermissionsArePermanentlyDenied = myMap[
      'Location_permissions_are_permanently_denied_we_cannot_request_permissions'];

  static String editAddress = myMap['Edit_Address'];
  static String getDeviceLocation = myMap['Get_Device_Location'];
  static String address_Delete_Successfull =
      myMap['Address_Delete_Successfull'];
  static String placeOrder = myMap["Place_Order"];
  static String paymentsMethod = myMap["Payments_Method"];
  static String addPaymentsMethod = myMap["Add_Payment_Method"];
  static String payments = myMap["Payments"];
  static String payment = myMap["Payment"];
  static String payment_ = myMap["Payment"];
  static String pleaseAgreeWithPrivacyPolic =
      myMap["Please_agree_with_privacy_policy"];
  static String openAt = myMap["Open_At"];
  static String closedAt = myMap["Closed_At"];

  static String thankYou = myMap["Thank_you"];
  static String shippingCharge = myMap["Shipping_charge"];
  static String pleaseLoginFirst = myMap["Please_login_First"];
  static String flashDeal = myMap["Flash_Deal"];
  static String noItem = myMap["No_Item"];
  static String noItems = myMap["No_Items"];
  static String subCategory = myMap["Sub_Category"];
  static String somethingIsWrong = myMap["Somethings_went_wrong"];
  static String maxValueMustBeGreterThenValue =
      myMap["maxValue_must_be_greter_then_value"];
  static String areYouSureYouWishToRemoveThisItem =
      myMap["Are_you_sure_you_wish_to_remove_this_item"];

  static String woo = myMap["Woo"];
  static String messages = myMap["Messages"];
  static String noChatAvailable = myMap["No_chat_available"];
  static String send = myMap["Send"];
  static String continue_ = myMap["Continue"];
  static String pay = myMap["Pay"];
  static String paymentFailed = myMap["Payment_Failed"];

  static String enterCurrentPassword = myMap["Enter_current_password"];
  static String enterReEnterPassword = myMap["Enter_Reenter_password"];
  static String passwordDosentMatch = myMap["Password_dosent_match"];

  static String searcHere = myMap["Search_here"];

  static String addPaymentMethod = myMap["Add_Payment_Method"];
  static String addCardInfo = myMap["Add_Card_info"];
  static String cardNumber = myMap["Card_Number"];
  static String cardHolderName = myMap["Card_holder_Name"];
  static String expiredDate = myMap["Expired_Date"];
  static String saveMyCardDetails = myMap["Save_my_card_Details"];
  static String addNewCard = myMap["Add_New_Card"];
  static String playlist = myMap["Playlist"];

  static String waitStartSendingCode = myMap["waitStartSendingCode"];
  static String waitSendingCode = myMap["waitSendingCode"];
}
