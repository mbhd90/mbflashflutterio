...
import 'package:bm_flash/modules/cart/model/cart_product_model.dart';
...
class Utils {
  ...
  static String formatPrice(var price, BuildContext context) {
    ...
    if (price is String) {
      ...
      return '${p.toStringAsFixed(1)} $currency';
    }
  ...
  static String formatPriceIcon(var price, String icon) {
    ...
    if (price is String) {
      final p = double.tryParse(price) ?? 0.0;
      return p.toStringAsFixed(1) + " " + icon;
    }
    return price.toStringAsFixed(1) + " " + icon;
  }
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              InfoLabel(
                  label: Language.name.capitalizeByWord(), text: "BM-Flash"),
              const SizedBox(height: 6),
              InfoLabel(
                  label: Language.version.capitalizeByWord(), text: APPVERSION),
              const SizedBox(height: 6),
              InfoLabel(
