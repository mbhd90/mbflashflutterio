...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void _setValueIntoController(EditAddressModel editAddressModel) {
    ...
    _phonCode = editAddressModel.address.phoneCode;
    _type = editAddressModel.address.type;
  }
              ...
              if (editState is EditAddressLoading) {
                ...
                return BlocBuilder<CountryStateByIdCubit,
                  ...
                  builder: (context, countryState) {
                    ...
                    try{
                      position = new LatLng(editState.editAddressModel.address.latitude, editState.editAddressModel.address.longitude);
                    }catch(err){
                      print(err);
                    }
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: CountryCodePicker(
                                  ...
                                  initialSelection: 'CM',
                                  favorite: [],
                                  countryFilter: countries.map((CountryModel value) => value.code).toList(),
