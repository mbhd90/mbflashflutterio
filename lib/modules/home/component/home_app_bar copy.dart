...
import 'package:bm_flash/modules/home/component/search_field.dart';
...
class HomeAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Container(
        height: height,
        color: lightningYellowColor, //const Color(0xffF6F6F6),
          ...
          children: [
           ...
           SearchField(),
            /*Row(
              ...
              children: [
                //const Spacer(),
                CustomImage(path: RemoteUrls.imageUrl(logo)/* Kimages.logoIcon*/, height: 24),
                const Spacer(),
