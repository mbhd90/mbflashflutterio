...
class _DrawerFilterState extends State<DrawerFilter> {
    ...
    return BlocBuilder<SellerProductCubit, SellerProductState>(
      builder: (context, state) {
        if (state is SellerProductLoadingState) {
          ...
          final filterOptions =
              context.read<SellerProductCubit>().homeSellerModel;
                ...
                children: [
                  ...
                  PrimaryButton(
                      ...
                      onPressed: () {
                        ...
                        loadMoreBloc.page = 1;
                        loadMoreBloc.getFilterSellerProducts(data);
  ...
  Widget allVariantItems(SellerProductModel filterOptions, int index) {
    return Wrap(
      children: [
        ...List.generate(
  ...
  Widget allBrandItems(SellerProductModel filterOptions) {
    return Wrap(
      children: [
        ...List.generate(
