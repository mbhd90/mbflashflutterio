...
class ProfileEditStateModel extends Equatable {
  ...
  @override
  String toString() {
    return 'ProfiltEditStateModel(name: $name, email: $email, phone: $phone, phoneCode: $phoneCode, address: $address, image: $image, country: $country, state: $state, city: $city, status: $stateStatus)';
  }
