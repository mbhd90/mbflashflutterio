...
class _ProfileEditFormState extends State<ProfileEditForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final _countries = context
        .read<CountryStateByIdCubit>()
        .countryList
        .map((CountryModel value) => value.code)
        .toList();
    final all_countries = context
        .read<CountryStateByIdCubit>()
        .countryList
        .map((CountryModel value) => value)
        .toList();
                          ...
                          onChanged: (country) {
                            ...
                            all_countries.forEach((value) {
                              if (value.phone_code == country.dialCode) {
                                ...
                                context
                                    .read<ProfileEditCubit>()
                                    .changeCountry(value.id.toString());
                              }
                            });
                            profileEdBlc
                ...
                return Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      // },
                      decoration: InputDecoration(
                          hintText: Language.searcHere.capitalizeByWord()),
                    ),
                    if (edit is ProfileEditFormValidState) ...[
