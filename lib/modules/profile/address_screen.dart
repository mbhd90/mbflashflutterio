...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: RoundedAppBar(titleText: Language.addresses.capitalizeByWord()),
...
class _LoadedWidgetState extends State<_LoadedWidget> {
  ...
  final addressIds = {
    Language.billingAddress.capitalizeByWord(): 0,
    Language.shippingAddress.capitalizeByWord(): 0
  };

  @override
  Widget build(BuildContext context) {
    if (widget.address.addresses.isNotEmpty){
      for(var address in  widget.address.addresses){
        //print(address);
        
        if(address.defaultBilling == 1){
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  //hello
                  //print("widget.address.addresses[index] == " );
                  //print(widget.address.addresses[index]);
                  //hello
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        if (addressTypeSelect ==
                          ...
                          final dataMap = {
                            'address_id': billingAddressId.toString()
                          };
                          ...
                          final dataMap = {
                            'address_id': shippingAddressId.toString()
                          };
                      ...
                      child: Dismissible(
                        ...
                        onDismissed: (direction) {
                          Utils.showSnackBar(
                              context, Language.address_Delete_Successfull);
                        },
