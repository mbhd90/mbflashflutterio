...
class _ProfileEditFormState extends State<ProfileEditForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final _countries = context.read<CountryStateByIdCubit>().countryList.map((CountryModel value) => value.code).toList();
    final all_countries = context.read<CountryStateByIdCubit>().countryList.map((CountryModel value) => value).toList();
                ...
                return Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      // },
                      decoration: InputDecoration(
                          hintText: Language.yourAddresses.capitalizeByWord()),
                    ),
                    if (edit is ProfileEditFormValidState) ...[
